...
public class ArtigoCultural implements Vendavel {
    ...
    public boolean equals(Object o) {
        ...
        return id == ArtigoCultural.this.id && Objects.equals(descricao, item.descricao);
        // são considerados somente o id e a descrição do produto para conferir se os objetos são iguais
    }

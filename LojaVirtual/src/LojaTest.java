...
public class LojaTest {
    ...
    public void testarVendaParaProdutoExistente() {
        ...
        recibo = loja.receberPedido(bicicleta1, 1, comprador);
        assertNotNull(recibo);
        System.out.println(recibo);
    }
    ...
    @Test
    public void testarObjetosIguais() {
        assertEquals(false, livro1.equals(livro2));
    }
    @Test
    public void testarQuantidadeIndisponivel() {
        String recibo = loja.receberPedido(cd1, 2, comprador);
        assertNull(recibo);
    }
    @Test
    public void testarVendaComEnderecoDeEntregaInvalido() {
        comprador = new Usuario(000000, "Joao"); // Não setando o endereço para invalidar a compra
